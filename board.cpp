...
namespace ariel {
    ...
    Board::Board() {
       ...
       Spot(),Spot(),Spot(),Spot(),Spot(),Spot(),
        ...
        spots[7].setSpot({resources[0]}, {10, 12}, {3,11,12});
        spots[8].setSpot({resources[0], resources[0], resources[1], resources[4]}, {10, 6, 2}, {4,12,13});
        spots[9].setSpot({resources[1], resources[2], resources[5]}, {2, 9, 4}, {5,13,14});
        spots[10].setSpot({resources[2], resources[6]}, {9,10}, {6,14,15});
        ...
        spots[16].setSpot({resources[3], resources[7]}, {12, 9}, {11,21,22});
        spots[17].setSpot({resources[3], resources[4], resources[8]}, {12, 6, 11}, {12,22,23});
        spots[18].setSpot({resources[4], resources[5], resources[9]}, {6, 4, 0}, {13,23,24});
        spots[19].setSpot({resources[5], resources[6], resources[10]}, {4, 10, 3}, {14,24,25});
        spots[20].setSpot({resources[6], resources[11]}, {10, 8}, {15,25,26});
        ...
        spots[28].setSpot({resources[7], resources[8], resources[12]}, {9, 11, 8}, {22,33,34});
        spots[29].setSpot({resources[8], resources[9], resources[13]}, {11, 3, 0}, {23,34,35});
        spots[30].setSpot({resources[9], resources[10], resources[14]}, {3, 4, 0}, {24,35,36});
        spots[31].setSpot({resources[10], resources[11], resources[15]}, {3, 8, 5}, {25,36,37});
        ...
        spots[39].setSpot({resources[12], resources[13], resources[16]}, {8, 3, 5}, {34,43,44});
        spots[40].setSpot({resources[13], resources[14], resources[17]}, {3, 4, 6}, {35,44,45});
        spots[41].setSpot({resources[14], resources[15], resources[18]}, {4, 5, 11}, {36,45,46});
