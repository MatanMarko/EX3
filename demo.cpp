...
//         //cout << "It's your turn " << players[catan.endTurn()]->getColor() << players[catan.endTurn()]->getName() << "\033[0m" << endl;
...
//                     break;
//                 case 2:
//                     cout << "Where do you want to build it? (-1 to regret)" << endl;
//                     catan.placeRoad(*players[catan.getTurn()]);
//                     break;
//                 case 3:
//                     cout << "Choose settlement to upgrade. (-1 to regret)" << endl;
